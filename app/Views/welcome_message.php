...
<head>
	<meta charset="UTF-8">
	<title>OpenTexts.world</title>
	<meta name="description" content="Search, dosvier, and download open digitised texts and books">
...
<header>
    ...
    <div class="menu">
        <ul>
                ...
                <li class="menu-item hidden"><a href="/sources">Support</a></li>
...
-->
        ...
        <p>
            Currently the site only searches a limited number of <a href="/sources/">sources</a>. If your
                library hold a collection of digitised texts, why not become a <a href="/contribute/">contributor</a>?!
        </p>
