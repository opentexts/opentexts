<header class="mx-auto max-w-3xl flex justify-center items-center py-4 px-4 xs:space-x-2 sm:py-6 sm:space-x-6">
  <a href="/" class="rounded-sm p-2 -m-2">
      <!--img class="hidden xs:block w-12 sm:w-16" src="/images/logo.svg" alt="Open Texts" /-->
      <canvas class="hidden xs:block w-12 sm:w-16" height="94" width="94" id="logo" style="height: 52px;" onmouseover="isMouseOver = true; homeConstellationAnim(-1);" onmouseleave="isMouseOver= false;homeConstellationReverseAnim(-1);"></canvas>
  </a>
    <script>
        var firstPoints = [
